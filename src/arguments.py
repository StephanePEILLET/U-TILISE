...
eval_parser.add_argument(
    ...
    metavar="config-file",
    type=str,
    help="Configuration file generated by run_train.py (runtime config during training)",
)
eval_parser.add_argument(
    "method",
    type=str,
    help="Imputation method (choose 'trivial' to run a non-learned baseline",
    choices=["utilise", "trivial"],
)
...
eval_parser.add_argument(
    "--mode",
    type=str,
    required="trivial" in sys.argv,
    help="Mode for non-learned baselines",
